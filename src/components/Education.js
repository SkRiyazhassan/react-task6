  ...
  const educationData = [
    {
      ...
      description: 'Relevant coursework: Data Structures, Algorithms, Web Development, Databases, etc.',
    },
    {
      ...
      graduationDate: '2021',
      description: 'Achieved 95% in the intermediate exams.',
    },
    {
      institution: 'Pragati High School',
      degree: 'Secondary Education',
      fieldOfStudy: 'High School Diploma',
      graduationDate: '2019',
      description: 'Achieved a perfect 10 CGPA in secondary school.',
    },
  ];
